...
if ($_SESSION["id_perfil"]==3) {
	...
	$sql_fech_proy = "SELECT * FROM `fechas_limites` WHERE id_fechas_limites=2";
	$consult_fech_proy = mysql_query($sql_fech_proy,Conectar::con()) or die(mysql_error());
	$result_fech_proy = mysql_fetch_array($consult_fech_proy);
...
function ejecutarajax (fecha_limite) {
     var conexion;
     ...
     conexion.open("GET","actualizar-resticcion-proyecciones.php?fecha_limite="+fecha_limite,true);
     conexion.send();
...
document.write("<normal><font color='ffffff' face='Arial'>  "+daym+" de "+montharray[month]+" </font></small>")
      ...
      <div class="content">
		...
		<div class="body" id="tema1_contenido">
			<form name="frm_restr_proyect">
				<table width="380" border="0" cellspacing="0" cellpadding="0">
				  <tr>
				    <td colspan="2">Fecha máxima entrega proyecciones</td>
				  </tr>
				  <tr>
				    <td><input id="fecha_lim_proyecc" name="fecha_lim_proyecc" type="text" value="<?php echo $result_fech_proy["fecha_limite"];; ?>" /></td>
				    <td><div id="mensajerep"></div></td>
				  </tr>
				  <tr>
				    <td colspan="2"><button type="button" onclick="ejecutarajax(document.getElementById('fecha_lim_proyecc').value);" />Actualizar</button></td>
				  </tr>				  
				</table>		
				<!-- 
  ...
  <div class="navigation">
    ...
    <ul>
      ...
      <li><a href="./restricciones-reportes.php" target="_self">Reporte diario</a></li>
      <li><a href="./restricciones-proyecciones.php" target="_self">Proyecciones</a></li>
